...
<body>
	...
	<div class="container text-center">
		...
		<hr>
		<form class="form-horizontal" method="POST" action="/login-user/save-transaction">
	...
	<div class="form-group">
		...
		<div class="col-md-3">
		<input type="text" class="form-control" name="idsend" value="${transaction.idsend}" />
		</div>
	</div>
	<div class="form-group ">
	...
	<c:when test="${mode=='MODE_AFTERTRANSACTION'}">
	
	<div class="container" id="homediv">
		<div class="jumbotron text-center">
		<h2>You completed your transaction</h2>
